                      ...
                      FlatButton(
                        onPressed: (){
                          Navigator.push(
                              context,
                              PageRouteBuilder(
                                  pageBuilder:(context,animation,secondaryAnimation)=>Allorder(),
            ...
            child: Container(
              ...
              child: Stack(
                children: [
                  ...
                  Container(
                    alignment: Alignment(0.20,0.35),
                    child:SvgPicture.asset('assets/images/Star.svg'),
                  ),
                  Padding(
                    padding: const EdgeInsets.only(left:251.0,top:105),
                    child: FlatButton(
